...
Train/val draw maze sizes from MAZE_CONFIG.train_sizes/val_sizes; test
draws from MAZE_CONFIG.test_sizes - a disjoint set of sizes never seen
during training, so evaluating on it measures generalization across size.
Rows and columns are drawn independently and never equal (rows == columns
is asciimaze.varNxN's square-maze case).

Example:
    python -m asciimaze.varNxM.build_dataset --n 500 --seed 0
"""
