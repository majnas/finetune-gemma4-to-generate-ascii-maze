...
def build_sample(seed: int, sizes: tuple[int, ...]) -> dict:
    ...
    and test draw from disjoint size sets. Unlike varNxN, rows and columns
    are drawn independently and re-rolled until unequal - rows == columns
    is varNxN's square-maze case, not this one."""
