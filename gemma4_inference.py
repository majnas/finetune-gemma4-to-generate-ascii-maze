...
(`fixed4x4/experiment/lora`) or the merged model (`fixed4x4/experiment/merged`).
"""
...
def parse_args():
    ...
    parser.add_argument("--model-path", default="fixed4x4/experiment/lora",
                         help="LoRA adapters (e.g. fixed4x4/experiment/lora) or a "
                              "merged model (e.g. fixed4x4/experiment/merged)")
